...
function Contact() {
  ...
  return (
    <div
      id="contact"
      className="flex h-screen w-full flex-col items-center border-2 border-solid border-green-500 px-5 pb-5 md:px-10 md:pb-10 lg:px-20 lg:pb-20"
    >
      ...
      >
        <div id="buttons" className="flex w-full flex-col gap-5 pb-5">
          ...
          <Link
            ...
            target="_blank"
            rel="noreferrer"
            className="w-max cursor-pointer self-center border-x-0 border-b-4 border-t-0 border-solid border-primary-800 bg-transparent px-1 pb-2 text-xl font-medium uppercase leading-5 tracking-mobileParagraph text-primary-100 md:leading-8 md:tracking-tabletParagraph lg:tracking-desktopParagraph"
          >
            Télécharger mon CV
          </Link>
        </div>
